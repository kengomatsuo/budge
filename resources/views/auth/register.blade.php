<x-guest-layout>
    ...
    <form method="POST" action="{{ route('register') }}" novalidate>
        ...
        <div class="mt-6 text-center">
            ...
            <a class="ml-1 text-sm font-semibold text-primary-600 dark:text-primary-300 hover:text-primary-700 dark:hover:text-primary-200 transition-colors duration-200" href="{{ route('login') }}">
                {{ __('Sign in instead') }}
            </a>
        </div>
    </form>
