<x-guest-layout>
    ...
    <div class="mt-4 flex flex-wrap gap-2 items-center justify-between">
        ...
        <form method="POST" action="{{ route('logout') }}" class="w-full sm:w-fit">
            ...
            <x-secondary-button type="submit" class="w-full sm:w-fit underline text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 dark:focus:ring-offset-gray-800">
                {{ __('Log Out') }}
            </x-secondary-button>
        </form>
    </div>
