        ...
        <div class="min-h-screen bg-gradient-to-br from-gray-50 via-indigo-50/30 to-purple-50/20 dark:from-gray-900 dark:via-indigo-950/30 dark:to-purple-950/20">
            ...
            <div class="relative min-h-screen flex flex-col">
                    ...
                    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div class="flex justify-between items-center h-16">
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <span class="text-xl font-bold bg-gradient-to-r from-indigo-600 to-purple-600 dark:from-indigo-400 dark:to-purple-400 bg-clip-text text-transparent">Expense Tracker</span>
                            </div>

                            <!-- Auth Links - Only show Dashboard when logged in -->
                            @auth
                                <div class="flex items-center gap-2">
                                    <a href="{{ url('/dashboard') }}" class="inline-flex items-center px-4 py-2 rounded-lg text-sm font-semibold text-white bg-gradient-to-r from-indigo-600 to-indigo-700 dark:from-indigo-500 dark:to-indigo-600 shadow-sm hover:shadow-md hover:from-indigo-700 hover:to-indigo-800 dark:hover:from-indigo-600 dark:hover:to-indigo-700 transition-all duration-200 active:scale-95">
                                        Dashboard
                                    </a>
                                </div>
                            @endauth
                ...
                <main class="flex-1 flex items-center justify-center px-4 sm:px-6 lg:px-8 py-12">
                    <div class="max-w-7xl w-full">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                            <!-- Track Expenses Card -->
                            <a href="{{ route('expenses.index') }}" class="group p-6 bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl rounded-2xl shadow-sm hover:shadow-xl border border-gray-200/50 dark:border-gray-700/50 transition-all duration-300 hover:-translate-y-2">
                            ...
                            <a href="{{ route('expenses.create') }}" class="group p-6 bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl rounded-2xl shadow-sm hover:shadow-xl border border-gray-200/50 dark:border-gray-700/50 transition-all duration-300 hover:-translate-y-2">
                            ...
                            <!-- Budgets Card -->
                            <a href="{{ route('budgets.index') }}" class="group p-6 bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl rounded-2xl shadow-sm hover:shadow-xl border border-gray-200/50 dark:border-gray-700/50 transition-all duration-300 hover:-translate-y-2">
                        ...
                        @guest
                            <div class="mt-16 text-center">
                                <div class="inline-flex flex-col sm:flex-row gap-4">
                                    <a href="{{ route('register') }}" class="inline-flex items-center justify-center px-8 py-4 rounded-xl text-base font-semibold text-white bg-gradient-to-r from-indigo-600 to-purple-600 dark:from-indigo-500 dark:to-purple-500 shadow-lg hover:shadow-2xl hover:from-indigo-700 hover:to-purple-700 dark:hover:from-indigo-600 dark:hover:to-purple-600 transition-all duration-200 active:scale-95">
                ...
                <footer class="py-8 text-center">
                    <p class="text-sm text-gray-600 dark:text-gray-400">
                        <span class="font-semibold bg-gradient-to-r from-indigo-600 to-purple-600 dark:from-indigo-400 dark:to-purple-400 bg-clip-text text-transparent">Expense Tracker</span> — Modern financial management made simple
                    </p>
                </footer>
            </div>
        </div>
