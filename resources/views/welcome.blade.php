                ...
                <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                    ...
                    <main class="mt-6">
                        <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
                            ...
                            >
                                ...
                                <div class="relative flex items-center gap-6 lg:items-end">
                                        ...
                                        <div class="pt-3 sm:pt-5 lg:pt-0">
                                            <h2 class="text-xl font-semibold text-black dark:text-white">Track Expenses</h2>

                                            <p class="mt-4 text-sm/relaxed">
                                                Quickly record expenses, assign categories, and review your spending history. Add notes and easily find past entries.
                                            </p>
                                        </div>
                                    </div>

                                    <x-heroicon-o-arrow-right class="size-6 shrink-0 text-[#FF2D20]" />
                                </div>
                            </a>
                            ...
                            >
                                <div class="flex size-12 shrink-0 items-center justify-center rounded-full bg-[#FF2D20]/10 sm:size-16">
                                    <x-heroicon-o-photo class="size-5 sm:size-6 text-[#FF2D20]" />
                                </div>

                                <div class="pt-3 sm:pt-5">
                                    <h2 class="text-xl font-semibold text-black dark:text-white">Attach Receipts</h2>

                                    <p class="mt-4 text-sm/relaxed">
                                        Upload photos or PDFs of receipts to keep proof of purchase with each expense. Search and filter by attachment easily.
                                    </p>
                                </div>
                            ...
                            >
                                <div class="flex size-12 shrink-0 items-center justify-center rounded-full bg-[#FF2D20]/10 sm:size-16">
                                    <x-heroicon-o-users class="size-5 sm:size-6 text-[#FF2D20]" />
                                </div>

                                <div class="pt-3 sm:pt-5">
                                    <h2 class="text-xl font-semibold text-black dark:text-white">Shared Expenses</h2>

                                    <p class="mt-4 text-sm/relaxed">
                                        Create shared expense groups, split bills with friends or roommates, and settle balances easily.
                                    </p>
                                </div>
                            ...
                            <a href="{{ route('budgets.index') }}" class="flex items-start gap-4 rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-[#FF2D20] lg:pb-10 dark:bg-zinc-900 dark:ring-zinc-800 dark:hover:text-white/70 dark:hover:ring-zinc-700 dark:focus-visible:ring-[#FF2D20]">
                                <div class="flex size-12 shrink-0 items-center justify-center rounded-full bg-[#FF2D20]/10 sm:size-16">
                                        <x-heroicon-o-chart-pie class="size-5 sm:size-6 text-[#FF2D20]" />
                                    </div>

                                <div class="pt-3 sm:pt-5">
                                    <h2 class="text-xl font-semibold text-black dark:text-white">Budgets & Multi-Currency</h2>

                                    <p class="mt-4 text-sm/relaxed">
                                        Set monthly budgets, track progress with reports, and manage expenses across multiple currencies — built-in conversion keeps totals consistent.
                                    </p>
                                </div>
                    ...
                    <footer class="py-16 text-center text-sm text-black dark:text-white/70">
                        Expense Tracker — Manage expenses, attach receipts, share costs, and track budgets across currencies.
                    </footer>
                </div>
            </div>
        </div>
