            ...
            <div class="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg">
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        ...
                        <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-4 border-l-4" style="border-color: {{ $category->color ?? '#3B82F6' }}">
                            <div class="flex justify-between items-start">
                                ...
                                <div class="flex space-x-2">
                                    <a href="{{ route('categories.edit', $category) }}" class="text-blue-600 hover:text-blue-800 dark:text-blue-400">
